...
class Roomfacility_model extends CI_Model {
	...
	function insert_data() {
		...
		$this->db->insert('hom_facility_room', $data);
	}
	...
	function update_data() {
		...
		$this->db->update('hom_facility_room', $data);
	}

	function delete_data($kode) {
		$this->db->where('facility_id', $kode);
		$this->db->delete('hom_facility_room');
	}
}
/* Location: ./application/model/admin/Roomfacility_model.php */