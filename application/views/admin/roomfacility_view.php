...
<script>
    function hapusData(facility_id) {
        ...
        swal({
            ...
            window.location.href="<?php echo site_url('admin/roomfacility/deletedata'); ?>"+"/"+id
        });
    }
</script>
    ...
    <div class="modal-dialog"> 
        <div class="modal-content">
            <div class="modal-header"> 
                ...
                <h4 class="modal-title"><i class="fa fa-plus-circle"></i> Add Data Room Facility</h4> 
            </div>
            
            <form action="<?php echo site_url('admin/roomfacility/savedata'); ?>" method="post" enctype="multipart/form-data">
...
<div id="editdata" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog"> 
        <div class="modal-content">
            <div class="modal-header"> 
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> 
                <h4 class="modal-title"><i class="fa fa-edit"></i> Edit Data Room Facility</h4> 
            </div>
            
            <form action="<?php echo site_url('admin/roomfacility/updatedata'); ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box table-responsive">                    
                    <h4 class="m-t-0 header-title"><b>Room Facility List</b></h4>
                    <p>Master Room Facility</p>
